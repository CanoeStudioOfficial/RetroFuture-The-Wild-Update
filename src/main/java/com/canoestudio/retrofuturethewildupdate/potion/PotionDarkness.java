...
public class PotionDarkness extends Potion {
    ...
    public void renderHUDEffect(PotionEffect effect, Gui gui, int x, int y, float z, float alpha) {
        ...
        buffer.pos(x + 3, y + 3 + 18, 0.0).tex(0.0, 1.0).endVertex();
        buffer.pos(x + 3 + 18, y + 3 + 18, 0.0).tex(1.0, 1.0).endVertex();
        buffer.pos(x + 3 + 18, y + 3, 0.0).tex(1.0, 0.0).endVertex();
        buffer.pos(x + 3, y + 3, 0.0).tex(0.0, 0.0).endVertex();
        tessellator.draw();
    }
